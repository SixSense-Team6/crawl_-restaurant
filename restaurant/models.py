...
class Review(models.Model):
    ...
    def __str__(self):
        return f'{self.restaurant.restaurant_name} - {self.get_review_display()}'
...
class Menu(models.Model):
    ...
    price = models.CharField(max_length=100, verbose_name='가격', null=False)   # int로 가공 필요

    def __str__(self):
        return f'{self.restaurant.restaurant_name} - {self.menu_name} - {self.price}'