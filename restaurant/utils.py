...
------------------------------------------------------------
    ...
    for restaurant in chef_instance.restaurants.all():     
        ...
        reviews.append(make_wordcloud(good_reviews_list, font_path, 300, stopwords_path, thumb_up_img_path))
        reviews.append(make_wordcloud(bad_reviews_list, font_path, 300, stopwords_path, thumb_down_img_path))
